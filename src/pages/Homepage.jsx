    ...
    return (
        <div className="Homepage min-h-screen bg-[#020817] text-[#f8fafc] font-sans">
            ...
            <div className="flex flex-col gap-10">
                {/* HERO SECTION */}
                <section className="relative grid lg:grid-cols-2 grid-cols-1 gap-12 px-16 lg:px-32 py-24 items-center">
                    ...
                    <span className="inline-flex items-center gap-2 bg-cyan-950/30 px-4 py-1.5 rounded-full text-xs font-medium text-cyan-400 border border-cyan-800/50 uppercase tracking-wider">
                        ...
                        <h1 className="text-5xl lg:text-8xl font-extrabold mt-8 tracking-tight">
                ...
                <section className="px-6 lg:px-20 pt-20 pb-20 border-t border-white/5 mb-32">
                ...
                {/* GOALS SECTION */}
                <section className="px-6 lg:px-20 pt-20 pb-20 border-t border-white/5 mb-32">
                    <h2 style={{ fontFamily: "'Nunito', sans-serif" }} className="text-4xl lg:text-5xl text-center mb-16 text-white tracking-wide font-bold">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-gradient-to-b from-[#0f172a] to-transparent p-10 rounded-[2.5rem] border border-white/5 hover:border-cyan-500/30 transition-colors group flex flex-col items-center text-center">
                ...
                <section className="px-6 lg:px-20 pt-20 pb-20 border-t border-white/5 bg-[#020817] mb-32">
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">

                        {/* Nội dung bên trái */}
                        <div className="space-y-8 text-center lg:text-left">
                            <h2 style={{ fontFamily: "'Nunito', sans-serif" }} className="text-4xl lg:text-5xl mb-12 text-white tracking-wide font-bold">
                                Hệ thống bản đồ <br />
                                <span className="text-blue-500">TRỰC QUAN</span>
                            </h2>
                            <br/>
                            <p className="text-gray-400 text-lg leading-relaxed mx-auto lg:mx-0 max-w-xl">
                                ...
                                <div className="grid grid-cols-12 gap-4 items-end">
                                    ...
                                    <div className="col-span-5 space-y-3">
                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            ...
                                            <button onClick={() => setIsVolunteerOpen(true)} className="w-full bg-[#1e293b]/90 hover:bg-[#334155] backdrop-blur-md text-white p-3 rounded-xl flex items-center gap-3 text-[10px] font-bold border border-white/5 transition-all shadow-lg">
                                                <span className="opacity-80">👥</span>
                ...
                {/* QUY TRÌNH HOẠT ĐỘNG */}
                <section className="px-6 lg:px-20 pt-20 pb-20 border-t border-white/5 bg-[#010409] mb-32">
                    <h2 style={{ fontFamily: "'Nunito', sans-serif" }} className="text-4xl lg:text-5xl text-center mb-16 text-white tracking-wide font-bold">
                        Quy trình hoạt động
                    </h2>
                    <br/>
                ...
                <section className="relative py-24 text-center overflow-hidden bg-[#010409] w-full flex flex-col items-center justify-center border-t border-white/5 mb-32">
                    <div className="relative z-10">
                        <br/>
                        <h2 style={{ fontFamily: "'Nunito', sans-serif" }} className="text-4xl lg:text-5xl text-center mb-6 text-white tracking-wide font-bold">
                            Sẵn sàng hỗ trợ cộng đồng?
                        </h2>

                        <p className="text-gray-400 mb-12 max-w-2xl mx-auto text-base lg:text-lg leading-relaxed">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <button
                                onClick={() => setIsFormOpen(true)}
                                className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all active:scale-95 shadow-lg shadow-red-900/20"
                            >
                                🚨 Gửi SOS ngay
                            </button>
                            <Link
                                to="/map"
                                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all active:scale-95 shadow-lg shadow-blue-900/20"
                            >
                                📖 Truy cập bản đồ
                            </Link>
                        </div>
                ...
                <div id="lien-he" className="px-6 lg:px-20 py-20 bg-[#020817] scroll-mt-20 flex justify-center border-t border-white/5 mb-20">
                    <div className="w-full max-w-3xl bg-[#0f172a]/50 backdrop-blur-md rounded-3xl p-10 lg:p-12 border border-white/5 shadow-2xl">
                        {/* Tiêu đề */}
                        <br/>
                        ...
                        {/* Form */}
                        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Cảm ơn bạn đã liên hệ!'); e.target.reset(); }}>
                            ...
                            <div className="text-center pt-6">
                                <button type="submit"
                                        className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-xl font-bold transition-all shadow-lg active:scale-95 inline-flex items-center gap-2"
                                >
                                    ⚠️ Gửi tin nhắn
                                </button>
                                <br/>
