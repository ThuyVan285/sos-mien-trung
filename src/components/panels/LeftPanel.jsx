...
const stats = [
    ...
    { title: "ĐÃ HỖ TRỢ", value: 320, sub: "+25 hôm nay", className: "success", icon: "✅" },
    { title: "ĐIỂM CỨU TRỢ", value: 24, sub: "+2 hôm nay", className: "primary", icon: "📍" },
];
...
const hotspots = [
    ...
    { name: "Huế", value: 36 },
    { name: "Đà Nẵng", value: 28 },
    { name: "Khánh Hòa", value: 16 },
];
                ...
                <div className="hotspot-list">
                    {hotspots.map((item, i) => (
                        <div key={i} className="hotspot-item">
                            ...
                            <div className="hotspot-count">{item.value}</div>
                        </div>
                    ))}
                </div>
            </div>

            <div className="sidebar-footer">© 2024 SOS Miền Trung – Điểm Cứu Trợ</div>
        </aside>
    );
}